...
<div class="container-fluid">
 ...
 <div class="col-lg-4" align="left">
    <div class="input-group" >
      <span class="input-group-btn">
        <html:submit styleClass="btn btn-default"><bean:message key="Search"/></html:submit>
      </span>
 ...
 <div class="col-lg-4" align="left">
    <div class="input-group">
      <span class="input-group-btn">
        ...
        <a href="CreerContact.do" class="btn btn-info"><bean:message key="Add.new.contact"/></a>
      </span>
    </div><!-- /input-group -->
  </div><!-- /.col-lg-6 -->
 ...
 <div class="panel panel-info">
   ...
   <div class="panel-heading"> <h1><bean:message key="Contact.List"/></h1>
...
<%
 ...
 ArrayList<Contact> maListe = cs.afficheContact() ;
