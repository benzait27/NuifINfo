...
import org.lip6.struts.actionForm.Phone.SearchActionForm;
...
public class SearchphoneAction extends Action {
	...
	public ActionForward execute(final ActionMapping pMapping,
		...
		final ArrayList<Object> list = lDAOContact.SearchPhone(search);
		
		RequestDispatcher rd = pRequest.getRequestDispatcher("/pages/Phone/SearchResultat.jsp");
